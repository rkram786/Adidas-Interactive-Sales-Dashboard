...
# Load the Excel file
df = pd.read_excel(r"C:\Users\Welcome\Downloads\Adidas.xlsx")
...
# Load image with PIL
image_path = r"C:\Users\Welcome\Downloads\adidas-logo.jpg"
image = Image.open(image_path)

# Create columns for layout
col1, col2 = st.columns([0.2, 1.0])

# Display the logo
with col1:
    st.image(image, width=180)

# Display title with updated font and alignment
html_title = """
    <style>
